...
## Rotating facet labels

```{r, fig.width = 6, fig.height = 6}
mtcars_with_long_labels <- mtcars
mtcars_with_long_labels$cyl_long <- sprintf(
  "Cars that have %s cylinders exactly",
  mtcars_with_long_labels$cyl
)

ggplot(mtcars_with_long_labels, aes(wt, mpg)) +
  geom_point() +
  facet_wrap(~cyl_long, nrow = 1) +
  easy_rotate_facet_labels()
```
