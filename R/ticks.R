...
#' p + easy_ticks(sides = 'l')
#'
#' # add identity scale minor ticks on x,y axis
#' p + easy_ticks(sides = 'lb')
#'
#' # Control number of minor ticks of each side independently
#'
#' # add identity scale minor ticks on x,y axis
#' p + easy_ticks(sides = 'lb', ticks_per_base = c(10,5))
#'
#' # log10 scale
#' p1 <- p + scale_x_log10()
#'
#' # add minor ticks on log10 scale
#' p1 + easy_ticks(sides = 'b', scale = 'log10')
#'
#' # add minor ticks on both scales
#' p1 + easy_ticks(sides = 'lb', scale = c('identity','log10'))
#'
#' # add minor ticks on both scales, but force x axis to be identity
#' p1 + easy_ticks(sides = 'lb', scale = 'identity')
#'
#' # log scale
#' p2 <- p + scale_x_continuous(trans = 'log')
#'
#' # add minor ticks on log scale
#' p2 + easy_ticks(sides = 'b', scale = 'log')
#'
#' # add minor ticks on both scales
#' p2 + easy_ticks(sides = 'lb', scale = c('identity','log'))
#'
#' # add minor ticks on both scales, but force x axis to be identity
#' p2 + easy_ticks(sides = 'lb', scale = 'identity')
#'
#' @import grid
#' @import ggplot2
easy_ticks <- function(sides = "b",
                             scale = "identity",
                             scaled = TRUE,
                             short = unit(0.1, "cm"),
                             mid = unit(0.2, "cm"),
